...
project = u'SeidarT'
copyright = u'%s, Steven Bernsen' % datetime.now().year
author = u'Steven Bernsen, Christopher Gerbi, Ian Nesbitt'

# The short X.Y version
# the version can be set here or imported from somewhere else
version = '1.0'
...
latex_documents = [
    (master_doc, 'SeidarT.tex', project+' Documentation',
     author, 'manual'),
]
...
texinfo_documents = [
    (master_doc, project, project+' Documentation',
     author, project, 'Seismic and Radar Modeling with Fortran',
     'Miscellaneous'),
]
...
pdf_documents = [(
    ...
    u'%s Documentation' % (project),        # title of the pdf
