...
#2D
cd fdtd
$f2pypath/f2py -c --fcompiler=gnu95 -m emfdtd2d emFDTD2D.f95
$f2pypath/f2py -c --fcompiler=gnu95 -m seismicfdtd2d seismicFDTD2D.f95
$f2pypath/f2py -c --fcompiler=gnu95 -m emfdtd25d emFDTD25D.f95
$f2pypath/f2py -c --fcompiler=gnu95 -m seismicfdtd25d seismicFDTD25D.f95
mv *.so ../bin
cd ..

# Synthetic microstructure
cd materials
$f2pypath/f2py -c --fcompiler=gnu95 -m orientsynth orientsynth.f95
mv *.so ../bin
cd ..
