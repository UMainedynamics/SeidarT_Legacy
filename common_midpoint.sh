...
while [[ total_offset -lt total ]]; do
	...
	python -m arrayplot $prjfile -c $c1 -I $xr $yr $zr -F $xr $yr $zr -d 1 -g 0 -S 1 -e 0.1
	...
	python -m arrayplot $prjfile -c $c2 -I $xr $yr $zr -F $xr $yr $zr -d 1 -g 0 -S 1 -e 0.1
...
python -m codisplay $prjfile -s $cmpfilex -d $ds -m e 0.15
