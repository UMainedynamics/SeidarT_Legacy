...
# If you have Anaconda installed then you need to point to your python binaries
# in order to correctly compile the fortran code
...
#2D
cd fdtd
$f2pypath -c --fcompiler=gnu95 -m emfdtd2d emFDTD2D.f95
$f2pypath -c --fcompiler=gnu95 -m seismicfdtd2d seismicFDTD2D.f95
$f2pypath -c --fcompiler=gnu95 -m emfdtd25d emFDTD25D.f95
$f2pypath -c --fcompiler=gnu95 -m seismicfdtd25d seismicFDTD25D.f95
mv *.so ../bin
cd ..
